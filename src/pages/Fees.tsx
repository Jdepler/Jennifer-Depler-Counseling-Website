       ...
       <section className="pt-20 pb-32 px-8 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-brand-text-muted leading-relaxed font-sans mb-4">
      ...
      <section className="px-8 md:px-12">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
              <motion.div
                ...
                className="bg-white p-12 md:p-16 rounded-[60px] border border-brand-cream-200 shadow-sm"
              >
                  <Tag className="w-10 h-10 text-brand-green-600 mb-8" />
                  <h3 className="text-3xl md:text-4xl font-serif text-brand-green-900 mb-10">Private Pay Rates</h3>
                  <div className="space-y-10">
                      <div className="flex justify-between items-center pb-8 border-b border-brand-cream-50">
                          <div>
                              <h4 className="text-2xl font-serif text-brand-green-900 mb-1">Individual Session</h4>
                              <p className="text-xs text-brand-text-muted uppercase tracking-widest font-sans font-bold opacity-60">50 Minutes</p>
                          </div>
                          <span className="text-3xl font-serif text-brand-green-600">$120</span>
                      </div>
                      <div className="flex justify-between items-center pb-8 border-b border-brand-cream-50">
                          <div>
                              <h4 className="text-2xl font-serif text-brand-green-900 mb-1">Consultation</h4>
                              <p className="text-xs text-brand-text-muted uppercase tracking-widest font-sans font-bold opacity-60">20-Minute Initial Fit Call</p>
                          </div>
                          <span className="text-3xl font-serif text-brand-green-600">Free</span>
                      </div>
                  </div>
                  <div className="mt-12 p-10 bg-brand-cream-100/30 rounded-[40px] border border-brand-cream-200 flex items-start gap-6">
                      <ShieldCheck className="w-6 h-6 text-brand-green-600 shrink-0 mt-1" />
                      <p className="text-base text-brand-green-900 leading-relaxed italic font-serif">
              ...
              >
                  <div className="p-12 md:p-16 rounded-[60px] bg-brand-green-900 text-brand-cream-50 border border-white/5 shadow-xl">
                      <h3 className="text-3xl font-serif mb-8 flex items-center gap-4">
                         <Info className="w-8 h-8 text-brand-green-600" />
                         Insurance
                      </h3>
                      <p className="text-brand-cream-100/70 leading-relaxed mb-10 font-sans text-lg">
                      ...
                      <div className="bg-white/5 p-8 rounded-[32px] border border-white/10 space-y-4">
                          <p className="text-xs text-brand-cream-100/40 font-sans uppercase tracking-widest font-bold">
                             Tip: Please check with your provider about Out-of-Network Behavioral Health benefits.
                          </p>
                          <p className="text-xs text-brand-cream-100/40 font-sans uppercase tracking-widest font-bold border-t border-white/5 pt-4">
                  ...
                  <div className="p-12 rounded-[40px] bg-white border border-brand-cream-200 shadow-sm">
                      <h3 className="text-2xl font-serif text-brand-green-900 mb-6 flex items-center gap-4">
                         <AlertCircle className="w-6 h-6 text-brand-green-600" />
                         Cancellation
                      </h3>
                  ...
                  <button 
                    ...
                    className="w-full text-left p-10 rounded-[40px] bg-brand-cream-100/30 border border-brand-cream-200 group hover:bg-brand-cream-100 transition-colors cursor-pointer"
                  >
                      <h3 className="text-xl font-serif text-brand-green-900 mb-4 flex items-center justify-between">
                        <span>Good Faith Estimate</span>
                        <div className="w-8 h-8 rounded-full border border-brand-green-200 flex items-center justify-center group-hover:border-brand-green-600 transition-colors">
                          {showGFE ? (
                            <Minus className="w-4 h-4 text-brand-green-600" />
                          ) : (
                            <Plus className="w-4 h-4 text-brand-green-200 group-hover:text-brand-green-600" />
                          )}
                        </div>
                      </h3>
                      <p className="text-sm text-brand-text-muted leading-relaxed font-sans mb-4">
                      ...
                      <AnimatePresence>
                        {showGFE && (
                          ...
                          >
                            <div className="pt-4 border-t border-brand-green-200/20 space-y-4 text-sm text-brand-text-muted font-sans">
                              <p>
                        ...
                        {showEmergency && (
                          ...
                          >
                            <div className="pt-4 border-t border-brand-green-200/20 space-y-4 text-sm text-brand-text-muted font-sans">
                              ...
                              <div className="bg-brand-cream-100/50 p-6 rounded-3xl border border-brand-cream-200">
                                <p className="font-bold text-brand-green-900 mb-2">Immediate Resources:</p>
                                <p className="text-[#B91C1C] font-bold mb-3 text-xs uppercase tracking-wider">Warning: Do NOT rely on an AI system for help in an emergency.</p>
